namespace Bookrent
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            Status.Location = new Point(665, 72);
            Status.Name = "Status";
            ...
            // 
            Note.AutoSize = true;
            Note.Location = new Point(86, 360);
            Note.Name = "Note";
            ...
            btnLogout.Location = new Point(781, 72);
            btnLogout.Name = "btnLogout";
            btnLogout.Size = new Size(88, 33);
            ...
            // 
            user.AutoSize = true;
            user.Font = new Font("Microsoft JhengHei UI", 14F, FontStyle.Bold, GraphicsUnit.Point, 136);
            user.Location = new Point(86, 25);
            user.Name = "user";
            user.Size = new Size(71, 36);
            user.TabIndex = 6;
            user.Text = "歡迎";
            // 
            // Form1
